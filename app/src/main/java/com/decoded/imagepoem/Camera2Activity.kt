...
import com.decoded.imagepoem.databinding.ActivityCamera2Binding
import java.io.File
...
class Camera2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(camera2Binding.root)
        ...
        camera2Binding.imageCaptureButton.setOnClickListener { takePhoto() }
//        camera2Binding.videoCaptureButton.setOnClickListener { captureVideo() }
...
//                    Toast.makeText(baseContext, msg, Toast.LENGTH_SHORT).show()
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(camera2Binding.viewFinder.surfaceProvider)
                }
    ...
    companion object {
        private const val TAG = "ImagePoem"
